...
export const projects: Project[] = [
  ...
  },
  {
    ...
    images: [
      '/projects/telkom/1.png',
      '/projects/telkom/2.png',
      '/projects/telkom/3.png',
      '/projects/telkom/4.png',
      '/projects/telkom/5.png',
      '/projects/telkom/6.png',
    ],
    liveUrls: [
  ...
  },
  {
    ...
    techStack: ['React.js', 'Nest.js', 'PostgreSQL', 'Tailwind', 'Node.js', 'RabbitMQ'],
    images: [
  ...
  },
  {
    ...
    company: 'Sahaware Teknologi Indonesia',
    role: 'Full Stack Developer',
    type: 'freelance',
    description: '',
    techStack: ['Javascript', 'JQuery', '.NET Framework', '.NetCore', 'Node.js'],
    images: ['/projects/ezcar/01-app.png', '/projects/ezcar/02-mobile.png'],
    liveUrls: [],
    featured: false,
  },
